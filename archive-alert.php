                    ...
                    <div class="filter-forms">	
                        <div class="search-form">
                            <div class="search-form-field">
                                <input type="text" class="form-control" name="search" id="search-input" placeholder="Search for Alerts">
...
<div class="container text-center" id="alert-loader">
...
<section class="profile-tabs-sec news-pg-sec">
    <div class="container-fluid">
		<div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            	<div class="row" id="alert-results">
...
$(function () {
    ...
    $("body").on('click touchstart', '.load-more', function (e) {
      e.preventDefault();
      $("#alert-results .col-12:hidden").slice(0, 3).slideDown();
      if ($("#alert-results .col-12:hidden").length == 0) {
