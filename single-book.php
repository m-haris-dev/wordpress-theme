  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8 col-12">
        ...
        <div class="publication-sec-content">
          <div class="publication-inner-text">
            ...
            <p><?php echo get_field("books_title"); ?></p>
            <ul><li><strong>Published On:</strong> <?php echo get_the_date(); ?></li></ul>
          </div>
          <div class="publication-butn pdf-hide">
            <?php if(!empty( get_field("book_download_pdf") )){ ?>
              <a href="<?php echo get_field("book_download_pdf"); ?>" target="_blank" class="rd-more-btn"><span>Download PDF</span> <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/ad-right-angle.png" class="ad-img"></a>
            <?php } ?>
            <ul>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-12">
        <?php
        $attorny_ids = get_field("books_attorney");
